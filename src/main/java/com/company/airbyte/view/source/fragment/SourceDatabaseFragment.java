...
public class SourceDatabaseFragment extends FragmentRenderer<VerticalLayout, SourceDatabaseDTO> {
    ...
    @ViewComponent
    private InstanceContainer<SourceMysqlDTO> mysqlDc;
    ...
    private SourceMysqlDTO extractOrCreateMySQLDTO(SourceDatabaseDTO item) {
            ...
            if (type != null) {
                switch (type) {
                    ...
                    case MSSQL:
                        ...
                        break;
                    case MYSQL:
                        fresh = metadata.create(SourceMysqlDTO.class);
                        break;
                    default:
